...
class Q931 : public PObject
{
  ...
  public:
	...
	int  HasFacIE(void) const;
    PBYTEArray GetIE(InformationElementCodes ie) const;
	PBYTEArray GetFacIE(int index) const;
  ...
  protected:
	...
	//PDICTIONARY(FacInformationElements, POrdinalKey, PBYTEArray);
    InternalInformationElements facInformationElements;
};
